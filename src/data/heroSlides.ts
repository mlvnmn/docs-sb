...
export const heroSlides: HeroSlide[] = [
  {
    image: '/assets/hero banner/1 banner hero.webp',
    alt: 'Be the Change Be the Future',
    titleLines: ['BE THE CHANGE', 'BE THE FUTURE'],
    tabLabel: 'Find your Programmes',
  },
  {
